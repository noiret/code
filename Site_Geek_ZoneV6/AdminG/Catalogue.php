...
<body>
	...
	<div class="textBandeau">
		...
		<br/>&nbsp;
		<!--   Catégorie produit : <input class="question" type="text" id="CatProduit" name="CatProduit"/>-->
		<datalist id="ListeCat">
		<?php 
		try{
	...
	if (isset($_POST['NomProduit']) && isset($_POST['DescProduit']) && isset($_POST['DetailProduit']) && isset($_POST['ImgProduit']) && isset($_POST['PrixProduit']) && isset($_POST['CatProduit']) ){
	...
	$CatProduit = htmlspecialchars($_POST['CatProduit']);
