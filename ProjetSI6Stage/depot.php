...
<?php 
 ...
 ?>
		...
		<legend>Ajout d'un stage :</legend>
			...
			Année du stage :    <input class="question" type="radio" id="AnneOffre" name="AnneOffre" value="1ans" checked="checked"/>1ère année
				    			<input class="question" type="radio" id="AnneOffre" name="AnneOffre" value="2ans"/>2ème année<br/>
			<?php 
			}
	...
	echo '<h1 class="titreSite"> Votre formulaire de stage pour '.$entrepriseOffre.' a '.$LieuOffre.' a bien été enregistré avec l\'identifiant '.$GenID.'</h1>';
